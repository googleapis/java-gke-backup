...
public class BackupForGKEClient implements BackgroundResource {
  ...
  public static class ListVolumeBackupsPagedResponse
      extends AbstractPagedListResponse<
          ListVolumeBackupsRequest, ListVolumeBackupsResponse, VolumeBackup, ListVolumeBackupsPage,
  ...
  public static class ListRestoresPagedResponse
      extends AbstractPagedListResponse<
          ListRestoresRequest, ListRestoresResponse, Restore, ListRestoresPage,
  ...
  public static class ListVolumeRestoresPagedResponse
      extends AbstractPagedListResponse<
          ...
          ListVolumeRestoresPage, ListVolumeRestoresFixedSizeCollection> {
